...
const login = async (req, res)=>{
    ...
    res.cookie("token", token, {httpOnly: true, maxAge: 3600000, sameSite: false});
...
const register = async (req, res)=>{
    ...
    try {
        ...
        res.cookie("token", jsonwebtoken.sign({email, name}, JWT_SECRET, {expiresIn: "1h"}), {httpOnly: true, maxAge: 3600000, sameSite: false});
